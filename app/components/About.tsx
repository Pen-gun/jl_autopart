      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start lg:gap-16">
          <ScrollReveal>
            ...
            <div className="mt-5 space-y-4 text-[0.95rem] leading-relaxed text-brand-600">
              <p>
          ...
          <ScrollRevealStagger className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            {highlights.map(({ icon: Icon, title, body }) => (
              <ScrollRevealItem key={title}>
                <Card className="rounded-xl border-brand-100 bg-brand-50/60 hover:border-accent-500/30">
                  <CardHeader>
                    <span className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-brand-900 text-accent-400">
                      <Icon className="h-5 w-5" strokeWidth={1.6} />
                    </span>
                    <CardTitle className="font-heading text-base font-semibold uppercase tracking-wide text-brand-900">
                      {title}
                    </CardTitle>
                    <CardDescription className="text-sm leading-relaxed text-brand-600">
                      {body}
                    </CardDescription>
                  </CardHeader>
                </Card>
